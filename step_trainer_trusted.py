...
AmazonS3_node1703855271599 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://project-stedi-human-balance/customer/curated/"],
        "recurse": True,
    },
...
AmazonS3_node1703855274129 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://project-stedi-human-balance/step_trainer/landing/"],
        "recurse": True,
    },
...
SqlQuery0 = """
select sensorReadingTime, myDataSource.serialNumber, distanceFromObject from myDataSource join myDataSource2 
...
AmazonS3_node1703855554447 = glueContext.getSink(
    path="s3://project-stedi-human-balance/step_trainer/trusted/",
    connection_type="s3",
