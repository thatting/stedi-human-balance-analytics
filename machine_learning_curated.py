...
AmazonS3_node1703855274129 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://project-stedi-human-balance/step_trainer/trusted/"],
        "recurse": True,
    },
...
SqlQuery2649 = """
select * from myDataSource join myDataSource2 
on myDataSource.sensorReadingTime = myDataSource2.timestamp;
"""
...
AmazonS3_node1703855554447 = glueContext.getSink(
    path="s3://project-stedi-human-balance/machine_learning/curated/",
    connection_type="s3",
